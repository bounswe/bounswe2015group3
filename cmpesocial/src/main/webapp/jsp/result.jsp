						...
						<div class="event-container clearfix">
							<div class="event clearfix">
								...
								<div class="event-content">
									<h3 class="title">
										<a href="#">Playing Table Tennis </a>
									</h3>
									<ul class="meta">
										<li><i class="icon fa  fa-group"> Group</i>
										<li><i class="icon fa  fa-user"> 14 Members</i>
										<li><i class="icon fa  fa-calendar-o"> Created: 31
												October 2015</i>
									</ul>
									<p>Masa tenisi oynayarak biraz stres atabiliriz gencler!</p>
									<a href="#" class="btn btn-pri">Join</a> <a href="#"
										class="btn btn-disabled">Go to page</a>
								</div>
							</div>
						</div>
						<div class="event-container clearfix">
