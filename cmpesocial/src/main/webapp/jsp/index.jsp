...
<section class="eventform newsection">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8 eventform-con">
                <form>
                    ...
                    <div class="form-input ">
                        <button class="btn btn-pri ">Find an Event</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="col-md-8">
                <aside id="aside" class="aside-bar-style-two clearfix">
                    ...
                    <div class="widget clearfix">
                        <h2>Events in October</h2>
                        <hr/>
                        <div class="top-ppost">
                            <div class="date">
                                <p><span>31</span>OCT</p>
                            </div>
                            <div class="content">
                                <h4  class="title"><a href="#">Arkadaşlar, halı saha maçı yapalım diyen?</a></h4>
                                <a href="#" class="meta"><i class="icon fa fa-map-marker"></i>Etiler </a>
                            </div>
                        </div>
                        <br/>
                        <div class="top-ppost">
                            <div class="date">
                                <p><span>25</span>OCT</p>
                            </div>
                            <div class="content">
                                <h4  class="title"><a href="#">Paint Ball Turnuvası diyorum. </a></h4>
                        ...
                        <div class="top-ppost">
                            <div class="date">
                                <p><span>23</span>OCT</p>
                            </div>
                            <div class="content">
                                <h4  class="title"><a href="#">Pes 2016 oynamak isteyen var mı? </a></h4>
                        ...
                        <div class="top-ppost">
                            <div class="date">
                                <p><span>15</span>OCT</p>
                            </div>
                            <div class="content">
                                <h4  class="title"><a href="#">Mission Impossible'i izlemek için sinemaya gidiyoruz</a></h4>
                                <a href="#" class="meta"><i class="icon fa fa-map-marker"></i>Trump Alışveriş Merkezi</a>
                            </div>
                        </div>
                    </div>
                ...
                <aside id="aside" class="aside-bar-style-two clearfix">
                    ...
                    <div class="widget clearfix">
                        ...
                        <div class="top-ppost">
                            ...
                            <div class="date">
                                <p><span><i class="icon fa fa-calendar"> </i></span>EVENT</p>
                            </div>
                            <div class="content">
                                <h4  class="title"><a href="#">Watching Star Wars in Kuzey Kampus Cinema </a></h4>
                            </div>
                        </div>
                        <hr/>
                        <div class="top-ppost">
                            <div class="date">
                                <p><span><i class="icon fa fa-group"> </i></span>GROUP</p>
                            </div>
                            <div class="content">
                                <h4  class="title"><a href="#">Orta Düzey Tenis Oyuncuları  </a></h4>
                            </div>
                        </div>
                    </div>
