				...
				<div class="col-md-8">
					<aside id="aside" class="aside-bar-style-two clearfix">
						<div class="widget clearfix">
							<h2>Create Group</h2>
							<hr />
							<form method="post" action="${contextPath}/group/update?id=${group.id}"
								class="form">

								<p>
									<label>Group Name</label> <input type="text" value="${group.name}"
										placeholder="Name of the group" id="name" name="name"
										class="textflied"> <i class="icon fa fa-group"></i>
								</p>
								<p>
									<label>Group Image Url</label> <input type="text" value="${group.group_url}"
								...
								<p>
									...
									<textarea style="width: 100%" name="description"
										id="description" rows="10">${group.description}
                                </textarea>
								</p>
								<p>
								...
								<button type="submit" name="submit" id="submitButton"
									class="btn btn-success">UPDATE Group</button>
								</p>
							</form>
						</div>
					</aside>
